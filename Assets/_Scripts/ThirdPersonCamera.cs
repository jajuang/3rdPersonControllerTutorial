...
public class ThirdPersonCamera : MonoBehaviour
{
	...
	void Start ()
	{
		...
		follow = GameObject.FindWithTag("Player").GetComponent<TP_Motor>();
	...
	{		
		...
		float leftTrigger = Input.GetAxis("Trigger Left");
		...
		{			
			...
			// * Free *
			if ((rightY < freeThreshold || mouseWheel < 0f) && System.Math.Round(follow.forwardSpeed, 2) == 0)
			{
